...
<input type="hidden" value="<?print($MemberID)?>" name="ModifyMemberID">
<table>
       <tr>
       ...
       <tr>
           ...
           <td><input READONLY name="NewFirstName" type="text" size="15" maxlength="15" value="<?print($currentRow["MemberFirstName"])?>"></td>
       </tr>

       <tr>
           <th align=left>Middle Name:</th>
           <td><input READONLY name="NewMiddleName" type="text" size="15" maxlength="15" value="<?print($currentRow["MemberMiddleName"]);?>"></td>
       </tr>

       <tr>
           <th align=left>Last Name:</th>
           <td><input READONLY name="NewLastName" type="text" size="15" maxlength="15" value="<?print($currentRow["MemberLastName"]);?>"></td>
       </tr>
